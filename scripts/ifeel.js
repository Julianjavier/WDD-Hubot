...
var lon = '-81.3055'; // longitude // These are currently for the Orlando area speciflicly Full Sail area.
var lat = '28.6079'; // latitude  //
...
function ifeel(msg){
  ...
  if (keyWord == 'hungry' || keyWord == 'bored'){
    ...
    /// This will filter proper commands to be passed into the new key word variable.
    if (keyWord === 'hungry'){          
    ...
    msg.send('Say Wha? Are you feeling hungry or bored?'); // This will let users know if we inputed the command incorrectly.
  }
